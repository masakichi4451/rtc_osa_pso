...
In such cases, \magenta{a user~$u$ restricted by~\eqref{OSA-PSO_g} must select a more distant server $s$ while minimizing the objective value in~\eqref{OSA-PSO_a}, which results in a slight increase in the user-server delay $x_{usf}d(u,s)$.}
